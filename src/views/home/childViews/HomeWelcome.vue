  ...
  <div class="homeWelcome">
    ...
    <div class="container">
      <div class="mainContent">
        <p>
          欢迎来到RDTime!<br /><br />
          RDTime为您提供各种免费可打印的工作表，供您在家或教室使用。你会发现数以千计的工作表适合学龄前到六年级的学生。这些教育工作表可用于补充您的幼儿教育计划、家庭日托资源、小学教室或家庭学校课程。<br /><br />
        ...
        <div class="newUpdate">
          ...
          <p>
            ...
            我们更新了所有拼写列表，并将其转换为易于打印的PDF文件。
            <br /><br />
            <span class="date">2022/4/5:</span>
            我们已经更新了网站的外观和感觉！我们希望这次重新设计能改善你对网站的体验，让你更容易更快地找到你想要的材料。如果您对此或本网站的任何其他方面有任何疑问或反馈，请访问我们的联系页面。感谢您访问RDTime！
            <br /><br />
          </p>
        </div>
        <div class="explore">
